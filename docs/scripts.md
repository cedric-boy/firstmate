...
| `fm-arm-pretool-check.sh` | Stable PreToolUse transport for the watcher-arm and agent self-kill command policy (docs/arm-pretool-check.md) |
| `fm-arm-command-policy.mjs` | Semantic owner of the watcher-arm and agent self-kill PreToolUse policy (docs/arm-pretool-check.md) |
